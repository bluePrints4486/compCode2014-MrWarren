...
public class ShiftHigh extends CommandBase {
    ...
    protected void initialize() {
        ...
        // because isFinished always returned false. Furthermore, the shiftHigh
        // method was being continuously called in the execute method. Since
        // the shiftHigh method is something that can done once and it will
        // hold that position, it is more efficient to call the shiftHigh method
